...
First, notice how the example ~={yellow}follows the UX research study plan template=~. Templates help designers ensure their research plans are complete, readable, and visually appealing. These features are especially helpful when you have to align a team on a plan or get approval from stakeholders.
...
For anyone who engages with the research plan, ~={yellow}these four details are crucial reminders of the project’s purpose, stakeholders, and timeframe=~. In the example, notice how:
...
As the example shows, a ~={cyan}project background=~ ~={yellow}**should offer**=~ a brief explanation of ~={yellow}why you’re doing the research=~. It gets the team aligned at the beginning of the study and shows you understand the reason for the research. Also, for people who can act on your research and recommendations, a well-crafted project background promotes confidence in the overall quality of your analysis and insights. 

Next, notice how the ~={cyan}research goals=~ indicate ~={yellow}what the researchers want to learn=~ from testing the CoffeeHouse app and ~={yellow}how the research results might affect their design decisions=~. They want to know whether collaborative ordering saves time.

~={cyan}Research goals=~ should clarify the ~={yellow}**specific ideas you want to learn**=~ from the research or the **~={yellow}outcomes you want to achieve=~**. As you craft research goals, think about questions like these: 
