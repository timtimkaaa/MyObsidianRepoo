...
This is a very very simple representation of how a brain works. 

We can roughly separate our brain into 2 parts: old brain and new brain. 

### Old brain

There are parts of our brain that we can trace back hundreds of millions of years. Some scientists talk about these parts being involved with the four "F"s: feeding, fighting, fleeing and... having sex. Also since we're mammals these parts are responsible for us taking care of children. Besides that, the "old brain" is also responsible for basic emotions, such as anxiety, anger and joy; sexual interest and motives; forming friendships; and belonging to groups. 

So to rephrase, our Old Brain takes care of:
- **The four "F"s**
	- Feeding
	- Fighting
	- Fleeting
...
- ~={yellow}**Basic emotions**=~, e.g. 
	...
	- lust
	- joy
- **Basic safety reflexes**, e.g.
	- Withdrawal (getting the hand off a hot surface)
- **Socializing**
	- Forming friendships
	- Belonging to groups
...
The new brain gives us the capacity for: 
- language
- thinking
- imagination
- planning
...
It also gives us more ways to learn, **besides conditioning**. We can learn through:
- consequences
- observation
- deduction
- indirect experience
...
The issue arises in collision of the old and the new brain.
 ...
 Let's use an example. Jennifer's "old brain" is preconditioned by evolution to fight, flight or freeze; seek status, approval, attachment to others and fear being ostracized.
